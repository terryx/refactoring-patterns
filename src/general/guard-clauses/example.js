...
function example1After(employee) {
    ...
    if (!employee.isSeparated && employee.isRetired) return { amount: 0, reason: 'retired' };
    if (!employee.isSeparated && !employee.isRetired && employee.isDead) return { amount: 0, reason: 'deceased' };
